...
declare module Cesium {
    ...
    class GeometryInstance {
        geometry: Geometry | RectangleGeometry;
        modelMatrix: Matrix4;
        id: any;
        attributes: any;
        constructor(options: { geometry: Geometry | RectangleGeometry; modelMatrix?: Matrix4; id?: any; attributes?: any });
    }
    ...
    class Entity {
        ...
        viewFrom: Property;
        wall: WallGraphics;
        constructor(options?: IEntityOption);
    ...
    class EntityCollection {
        ...
        add(entity: Entity | IEntityOption): Entity;
        computeAvailability(): TimeInterval;
        contains(entity: Entity): boolean;
